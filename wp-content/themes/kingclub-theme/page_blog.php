				...
				?>
                       	 <div class="tabs horizontal">
                                ...
                                <ul id="myTab" class="nav nav-tabs">
                                    <li class=" active"><a href="#blog-headlines" data-toggle="tab"><?php if($px_theme_option["trans_switcher"] == "on") { _e("Headlines",'Kings Club'); }else{  echo $px_theme_option["trans_headlines"];} ?></a></li>
                                    <li class=""><a href="#blog-recent" data-toggle="tab"><?php if($px_theme_option["trans_switcher"] == "on") { _e("Recent Posts",'Kings Club'); }else{  echo $px_theme_option["trans_recent"];} ?></a></li>
                                    <li class=""><a href="#blog-popular" data-toggle="tab"><?php if($px_theme_option["trans_switcher"] == "on") { _e("Popular Posts",'Kings Club'); }else{  echo $px_theme_option["trans_popular"];} ?></a></li>
                            	</ul>
                            	</header>
